...
# initial cube configuration w.r.t the fixed frame {s}
Tsc_initial = np.array([[1,0,0,1.2],[0,1,0,0.5],[0,0,1,0.025],[0,0,0,1]])
print("new initial cube configuration w.r.t the fixed frame {s}: ")
print(Tsc_initial)
# desired cube configuration w.r.t the fixed frame {s}
Tsc_desired = np.array([[0,1,0,0.5],[-1,0,0,-1.2],[0,0,1,0.025],[0,0,0,1]])
print("new desired cube configuration w.r.t the fixed frame {s}: ")
print(Tsc_desired)
...
np.savetxt("../results/newTask/referenceTrajectory.csv",endEfftrRefConfig,delimiter=",")
...
np.savetxt("../results/newTask/animation.csv",robotConfig,delimiter=",") 
...
plt.tight_layout()
plt.savefig("../results/newTask/xerr.png",dpi=600)
# plt.show()
print("Writing xerr plot data.")
np.savetxt("../results/newTask/xerr.csv",robotConfig,delimiter=",")
print("Done.")