...
# case 1: zero(home) configuration, zero velocity, zero torque, under gravity 3 seconds
...
#     # print("\n")
# # print(thetalist)
# np.savetxt('simulation1.csv',thetalist,delimiter=",")
...
np.savetxt('simulation2.csv',thetalist,delimiter=",")
