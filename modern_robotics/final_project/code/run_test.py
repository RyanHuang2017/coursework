...
np.savetxt("../results/referenceTrajectory.csv",endEfftrRefConfig,delimiter=",")
...
for i in range(N-1):
    ...
    # update currentConfig and Eint_prev for next control loop
...
np.savetxt("../results/animation.csv",robotConfig,delimiter=",") 
...
plt.tight_layout()
plt.savefig("../results/xerr.png",dpi=600)
plt.show()
print("Writing xerr plot data.")
np.savetxt("../results/xerr.csv",robotConfig,delimiter=",")
print("Done.")