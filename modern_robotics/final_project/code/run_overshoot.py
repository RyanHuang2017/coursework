...
np.savetxt("../results/overshoot/referenceTrajectory.csv",endEfftrRefConfig,delimiter=",")
...
np.savetxt("../results/overshoot/animation.csv",robotConfig,delimiter=",") 
...
plt.tight_layout()
plt.savefig("../results/overshoot/xerr.png",dpi=600)
# plt.show()
print("Writing xerr plot data.")
np.savetxt("../results/overshoot/xerr.csv",robotConfig,delimiter=",")
print("Done.")